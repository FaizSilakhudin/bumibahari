...
<div class="navbar-mobile-toggle justify-content-between align-items-center d-flex d-lg-none">
    <div class="d-flex align-items-center gap-2">
        <div class="logo-wbb-container" style="width: 36px; height: 36px;">
            <img src="../assets/img/wbb.png" alt="Logo" class="logo-wbb-img" onerror="this.style.display='none'; this.parentNode.insertAdjacentHTML('beforeend', '<i class=\'bi bi-graph-up-arrow text-warning fs-6\'></i>')">
        </div>
    ...
    <div class="sidebar-header d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-3">
            <div class="logo-wbb-container">
                <img src="../assets/img/wbb.png" alt="Logo WBB" class="logo-wbb-img" onerror="this.style.display='none'; this.parentNode.insertAdjacentHTML('beforeend', '<i class=\'bi bi-graph-up-arrow text-dark fs-5\'></i>')">
            </div>
