<?php
// PROTEKSI HALAMAN: Harus login dan role investor
...
<head>
    ...
    <style>
        ...
        .sidebar-container {
            ...
            box-shadow: 5px 0 25px rgba(46, 15, 58, 0.15);
        ...
        .logo-wbb-container {
            ...
            border: 2px solid rgba(217, 119, 6, 0.4); overflow: hidden; flex-shrink: 0;
        }
        ...
        .nav-link-custom {
            ...
            color: rgba(216, 180, 254, 0.8); font-weight: 500; font-size: 0.95rem;
        ...
        .nav-link-custom.active {
            color: #ffffff; background: linear-gradient(135deg, #d97706 0%, #b45309 100%);
            box-shadow: 0 8px 20px rgba(217, 119, 6, 0.35); font-weight: 600;
        }
...
<div class="navbar-mobile-toggle justify-content-between align-items-center d-flex d-lg-none">
    <div class="d-flex align-items-center gap-2">
        <div class="logo-wbb-container" style="width: 36px; height: 36px;">
            <img src="../assets/img/wbb.png?v=2" alt="Logo" class="logo-wbb-img" onerror="this.style.display='none'; this.parentNode.insertAdjacentHTML('beforeend', '<i class=\'bi bi-graph-up-arrow text-warning fs-6\'></i>')">
        </div>
    ...
    <div class="sidebar-header d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-3">
            <div class="logo-wbb-container">
                <img src="../assets/img/wbb.png?v=2" alt="Logo WBB" class="logo-wbb-img" onerror="this.style.display='none'; this.parentNode.insertAdjacentHTML('beforeend', '<i class=\'bi bi-graph-up-arrow text-dark fs-5\'></i>')">
            </div>
            <h5 class="sidebar-brand">
                Bumi Bahari
                <span style="color: #fbbf24; font-size: 0.75rem; font-weight: 500; text-transform: uppercase; margin-top: 2px; letter-spacing: 1px; display: block;">Portal Investor</span>
            </h5>
        </div>
