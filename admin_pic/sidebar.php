...
<div class="navbar-mobile-toggle justify-content-between align-items-center d-flex d-lg-none">
    <div class="d-flex align-items-center gap-2">
        <img src="../assets/img/wbb.png?v=2" alt="Logo" class="logo-wbb-img" style="height: 36px; max-width: 36px;" onerror="this.style.display='none'; this.parentNode.insertAdjacentHTML('beforeend', '<i class=\'bi bi-person-badge text-primary fs-6\'></i>')">
...
<div class="sidebar-container" id="sidebarContainer">
    <div class="sidebar-header d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-3">
            <img id="logoWWB" src="../assets/img/wbb.png?v=2" alt="Logo WBB" class="logo-wbb-img" onerror="this.style.display='none'; this.parentNode.insertAdjacentHTML('beforeend', '<i class=\'bi bi-person-badge text-dark fs-5\'></i>')">
